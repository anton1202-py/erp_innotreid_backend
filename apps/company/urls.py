...
urlpatterns = [
    ...
    path('companies/<int:inventory_id>/inventory/', UpdateInventoryView.as_view(), name='update-inventory'), 
    ...
    path('companies/<uuid:company_id>/calculate-supplier/', CalculationRecommendationSupplierView.as_view(), name='supplier'), 
    ...
    path('companies/<uuid:company_id>/calculate-priority/', CalculationRecommendationPriorityView.as_view(), name='priority'), 
