...
class ProductAdmin(admin.ModelAdmin):
    ...
    """
    list_display = ('id', 'vendor_code', 'place_in_warehouse', 'company')
    list_filter = ('company',)
    search_fields = ('vendor_code', 'place_in_warehouse')
    fieldsets = (
        (None, {'fields': ('vendor_code', 'place_in_warehouse', 'company')}),
    )
    ordering = ('id',)
...
class WildberriesProductSalesAdmin(admin.ModelAdmin):
    ...
    search_fields = ('product__vendor_code', 'wildberries__name')
    fieldsets = (
...
class OzonProductSalesAdmin(admin.ModelAdmin):
    ...
    search_fields = ('product__vendor_code', 'ozon__name')
    fieldsets = (
...
class YandexMarketProductSalesAdmin(admin.ModelAdmin):
    ...
    search_fields = ('product__vendor_code', 'yandex_market__name')
    fieldsets = (
